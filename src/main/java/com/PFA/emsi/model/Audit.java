...
public class Audit {
    ...
    public Audit(Long id, String name, String description, LocalDateTime startTime, LocalDateTime endTime, List<User> auditors, Process process, AuditResult auditResult, List<Action> actions, Standard standard) {
        this.id = id;
        this.name = name;
